                  ...
                  <div className="w-full">
                    ...
                    <div className="md:hidden">
                      ...
                      <div className="ml-12 space-y-4">
                        <div
                          className={`relative z-10 mt-2 inline-block rounded-full border ${styles.dateColor} px-4 py-2`}
                        >
                        ...
                        <div className="flex w-fit items-center space-x-3 rounded-lg border border-gray-600 bg-neutral-800 p-1 pr-4 shadow-lg">
                          {item.image ? (
                            ...
                            <div className="h-8 w-8 flex-shrink-0 rounded bg-gray-500"></div>
                          )}
                  ...
                  <>
                    ...
                    <div className="md:hidden">
                      ...
                      <div className="ml-12 space-y-4">
                        ...
                        <div
                          className={`relative flex w-fit items-center rounded-full border ${styles.cardColor} py-3 ${item.eventType === "marriage" && item.secondaryPerson ? "pr-18 pl-18" : "pr-4 pl-18"} shadow-lg`}
                        >
                          ...
                          {item.eventType === "marriage" &&
                            item.secondaryPerson && (
                              <div
                                className={`absolute top-1/2 right-0 h-16 w-16 -translate-y-1/2 overflow-hidden rounded-full border-3 ${styles.cardColor.split(" ")[0]} bg-gray-600`}
                              >
                      ...
                      <div className="flex items-start justify-center">
                        ...
                        <div className={`w-1/2 ${isLeft ? "pr-8" : "pr-16"}`}>
                          {isLeft && (
                            <div className="flex flex-col items-end space-y-4">
                              {/* Date bubble on left */}
                              <div
                                className={`relative z-10 mt-2 inline-block rounded-full border ${styles.dateColor} px-4 py-2 md:px-5 md:py-3`}
                              >
                        ...
                        <div className={`w-1/2 ${isLeft ? "pl-8" : "pl-8"}`}>
                          {isLeft ? (
                            ...
                            <div
                              className={`relative mt-2 flex w-fit items-center rounded-full border ${styles.cardColor} py-3 ${item.eventType === "marriage" && item.secondaryPerson ? "pr-24 pl-24" : "pr-4 pl-18"} shadow-lg md:py-4 ${item.eventType === "marriage" && item.secondaryPerson ? "md:pr-28 md:pl-28" : "md:pr-5 md:pl-24"}`}
                            >
                              {/* Primary person image */}
                              <div
                      ...
                      {!isLeft && (
                        <div className="absolute top-2 left-0 w-1/2 pr-8">
                          <div className="flex justify-end">
                            <div
                              className={`relative flex items-center rounded-full border ${styles.cardColor} py-3 ${item.eventType === "marriage" && item.secondaryPerson ? "pr-24 pl-24" : "pr-18 pl-4"} shadow-lg md:py-4 ${item.eventType === "marriage" && item.secondaryPerson ? "md:pr-28 md:pl-28" : "md:pr-24 md:pl-5"}`}
                            >
